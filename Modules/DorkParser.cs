    ...
    public class DorkParser
    {
        ...
        public static void LoadDorks()
        {
            ...
            var t = new Thread(() =>
            {
                ...
                Console.Write(Dorks.Count.ToString(), Color.Cyan);
        ...
        selectOption:
            ...
            Console.Write("Dorks", Color.Cyan);
            Console.Write("]", Color.White);
            LoadDorks();
            if (op1 != "1")
            {
                Console.Write("\n    [", Color.White);
                Console.Write("Select ", Color.White);
                Console.Write("Proxies", Color.Cyan);
                Console.Write("]", Color.White);
                LoadProxies();
                for (; ; )
                {
        ...
        {
            Console.Title = "                                                                                                 [>] Shock | Bing Parser | vx#1234 [<]";
            ...
            Console.Write("Done Parsing", Color.Cyan);
            Thread.Sleep(5000);
            Program.Menu0();
        }
        ...
        {
            Console.Title = "                                                                                                 [>] Shock | AOL Parser | vx#1234 [<]";
            for (; ; )
            {
        ...
        {
            Console.Title = "                                                                                                 [>] Shock | Ask Parser | vx#1234 [<]";
            for (; ; )
            {
                if (Program.Proxyindex > Program.Proxies.Count() - 2) Program.Proxyindex = 0;
                try
