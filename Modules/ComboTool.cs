...
namespace Shock.Modules
{
    public class ComboTool
    {
        ...
        public static void CaptureRemover()
        {
            ...
            Console.Write(" Combos", Color.Cyan);
            Console.Write("]\n", Color.White);
            ...
            var t = new Thread(() =>
            {
                ...
                Console.Write(Program.Combostotal, Color.Cyan);
            ...
            Thread.Sleep(250);
            Console.Write("    [", Color.White);
            Console.Write("Done Editing", Color.Cyan);
            Console.Write("]\n", Color.White);
            Thread.Sleep(500);
        ...
        public static void DupeRemover()
        {
            ...
            System.Console.WriteLine();
            Console.Write("    [", Color.White);
            Console.Write("Select Combos", Color.Cyan);
            Console.Write("]\n", Color.White);
            var type1 = DateTime.Now.ToString("dd-MM-yy HH-mm-ss");
            ...
            t.Join();
            Console.Write("    [", Color.White);
            Console.Write("Removing Dupes...", Color.Cyan);
            Console.Write("]\n", Color.White);
            ...
            Console.Write("    [", Color.White);
            Console.Write("Done Removing Dupes...", Color.Cyan);
            Console.Write("]\n", Color.White);
            Thread.Sleep(1000);
            Program.comboeditor0();
        }
        ...
        public static void MailPassEdit()
        {
            ...
            Console.Write("    [", Color.White);
            Console.Write("Cleaning Combos...", Color.Cyan);
            Console.Write("]\n", Color.White);
            ...
            var type1 = DateTime.Now.ToString("dd-MM-yy HH-mm-ss");
            Console.Write("    [", Color.White);
            Console.Write("Editing Combos...", Color.Cyan);
            Console.Write("]\n", Color.White);
            ...
            Console.Write("    [", Color.White);
            Console.Write("Randomizing Lines...", Color.Cyan);
            Console.Write("]\n", Color.White);
            var rnd = new Random();
            ...
            Thread.Sleep(250);
            Console.Write("    [", Color.White);
            Console.Write("Redirecting to Combo editor...", Color.Cyan);
            Console.Write("]\n", Color.White);
            Thread.Sleep(500);
            Program.comboeditor0();
        }
        ...
        public static void sorter()
        {
            ...
            Console.Write("DomainResults", Color.Cyan);
            Console.Write("' files Saved In", Color.White);
            Console.Write("]\n", Color.White);
            Thread.Sleep(3500);
            Console.Clear();
